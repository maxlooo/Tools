...
int main(void) {
	int day, month, zellermonth, year, century, year2digits, zeller, weekday;
	bool leap=false, days28=false, days29=false, days30=false, days31=false;
	void checkMonth(int, int * const);
	...
	switch (month) {
		...
		case 11: 
			...
			break;
		case 2: 
			if (leap) checkMonth(29, &day);
			else checkMonth(28, &day);
			break;
	}
...
void checkMonth (int daysinmonth, int * const dayaddress) {
	do {
