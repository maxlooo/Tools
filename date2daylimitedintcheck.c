...
int main(void) {
	...
	bool leap=false;
	void printDaysInMonth(int, const int * const);
...
// dayaddress pointing to const integer is valid because scanf works
void printDaysInMonth (int daysinmonth, const int * const dayaddress) {
	do {
